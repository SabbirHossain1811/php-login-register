...
if(!isset(  $_SESSION['author_id'])){
    header('location: ../../protfilo/signUp.php');
}
...
<head>
    ...
    <link href="../public/dash/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="../public/dash/plugins/perfectscroll/perfect-scrollbar.css" rel="stylesheet">
    <link href="../public/dash/plugins/pace/pace.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css" integrity="sha512-Kc323vGBEqzTmouAECnVceyQqyqdsSiqLQISBL29aUW4U/M7pSPA/gEUZQqv1cwx4OnYxTxve5UMg5GT6L4JJg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    
    <!-- Theme Styles -->
    <link href="../public/dash/css/main.min.css" rel="stylesheet">
    <link href="../public/dash/css/custom.css" rel="stylesheet">

    <link rel="icon" type="image/png" sizes="32x32" href="../public/dash/images/neptune.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="../public/dash/images/neptune.png" />
...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar ">
            <div class="logo">
                <a href=""><img style="width: 45px; border-radius: 50%;" src="../public/dash/images/sabbir.png"></a>
                <div style="display: flex;" class="sidebar-user-switcher">
                    <a href="#">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-flex">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link language-dropdown-toggle" href="#" id="languageDropDown" data-bs-toggle="dropdown"><img src="../public/dash/images/flags/us.png" alt=""></a>
                                        <ul class="dropdown-menu dropdown-menu-end language-dropdown" aria-labelledby="languageDropDown">
                                            <li><a class="dropdown-item" href="#"><img src="../public/dash/images/flags/germany.png" alt="">German</a></li>
                                            <li><a class="dropdown-item" href="#"><img src="../public/dash/images/flags/italy.png" alt="">Italian</a></li>
                                            <li><a class="dropdown-item" href="#"><img src="../public/dash/images/flags/china.png" alt="">Chinese</a></li>
                                        </ul>
                                </li>
                                <li class="nav-item hidden-on-mobile">
                                                ...
                                                <div class="notifications-dropdown-item">
                                                    <div class="notifications-dropdown-item-image">
                                                        <span class="notifications-badge">
                                                            <img src="../public/dash/images/avatars/avatar.png" alt="">
                                                        </span>
                                                    </div>
                                                    <div class="notifications-dropdown-item-text">
